...
namespace ISIC_SUBMARINE
{
    public partial class FormMain : Form
    {
        ...
        private UI_Remote _remote;
        private UI_Sensor _sensor;
        private UI_SerialPort _serialPort;
        ...
        public void SetConnected(bool isConnected)
        {
            try
            {
                if (isConnected == true)
                {
                    ...
                    this._remote.SetEnabledControl(true);
                    //this._console.ConnexionActive(true);
                }
                else
                {
                    this._remote.SetEnabledControl(false);
                    //this._console.ConnexionActive(false);
                }
            }
            catch (Exception ex)
            {
