...
temperature1_db = Queue.Queue(5)
temperature2_db = Queue.Queue(5)
temperature3_db = Queue.Queue(5)
temperature4_db = Queue.Queue(5)
temperature5_db = Queue.Queue(5)
temperature6_db = Queue.Queue(5)
temperature7_db = Queue.Queue(5)
temperature8_db = Queue.Queue(5)
adc1_db = Queue.Queue(5)
adc2_db = Queue.Queue(5)
adc3_db = Queue.Queue(5)
adc4_db = Queue.Queue(5)
accelerometer1_db = Queue.Queue(5)
hygrometer1_db = Queue.Queue(5)
hygrometer2_db = Queue.Queue(5)
impuls1_db = Queue.Queue(5)
impuls2_db = Queue.Queue(5)

#Valeur des capteurs pour US
temperature1_US = Queue.Queue(5)
temperature2_US = Queue.Queue(5)
temperature3_US = Queue.Queue(5)
temperature4_US = Queue.Queue(5)
temperature5_US = Queue.Queue(5)
temperature6_US = Queue.Queue(5)
temperature7_US = Queue.Queue(5)
temperature8_US = Queue.Queue(5)
adc1_US = Queue.Queue(5)
adc2_US = Queue.Queue(5)
adc3_US = Queue.Queue(5)
adc4_US = Queue.Queue(5)
accelerometer1_US = Queue.Queue(5)
hygrometer1_US = Queue.Queue(5)
hygrometer2_US = Queue.Queue(5)
impuls1_US = Queue.Queue(5)
impuls2_US = Queue.Queue(5)

#Valeur des capteurs pour Bluetooth
temperature1_BT = Queue.Queue(5)
temperature2_BT = Queue.Queue(5)
temperature3_BT = Queue.Queue(5)
temperature4_BT = Queue.Queue(5)
temperature5_BT = Queue.Queue(5)
temperature6_BT = Queue.Queue(5)
temperature7_BT = Queue.Queue(5)
temperature8_BT = Queue.Queue(5)
adc1_BT = Queue.Queue(5)
adc2_BT = Queue.Queue(5)
adc3_BT = Queue.Queue(5)
adc4_BT = Queue.Queue(5)
accelerometer1_BT = Queue.Queue(5)
hygrometer1_BT = Queue.Queue(5)
hygrometer2_BT = Queue.Queue(5)
impuls1_BT = Queue.Queue(5)
impuls2_BT = Queue.Queue(5)
    ...
    def run(self):
        while 1:
            ...
            if tab_data != None:
                ...
                print "Temperature 1 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            ...
            if tab_data != None:
                ...
                print "Temperature 2 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:
                ...
                print "Temperature 3 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:
                ...
                print "Temperature 4 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:
                ...
                print "Temperature 5 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "Temperature 6 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "Temperature 7 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "Temperature 8 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "ADC 1 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "ADC 2 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "ADC 3 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "ADC 4 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "Accelerometer 1 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "Hygrometer 1 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "Hygrometer 2 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "Impulsion 1 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
            ...
            if tab_data != None:            
                ...
                print "Impulsion 2 : [ " + str(tab_data[0]) + " | " + str(ord(tab_data[1])) + " | " + str(ord(tab_data[2])) + " ]"
            time.sleep(1./(self._Frequency/17.))
