...
{
	TCNT0 = 0x00;
	TCCR0B = (0<<CS02)|(1<<CS01)|(1<<CS00); // prescale de 64. => interruption toutes les 33*64*0.05=105,6µs
}
...
{
	TCNT2 = 0x00;
	TCCR2B = (1<<CS22)|(0<<CS21)|(0<<CS20); // prescale de 64. => interruption toutes les 33*64*0.05=105,6µs
}
